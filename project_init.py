...
# This environ variable is so the Django module itself can find all our project
# stuff.
...
file_location = os.path.join(current_location,
                             'catalog/fixtures/minerals.json')
...
def populate_database():
    ...
    for item in mineral_json:
        ...
        alpha.unit_cell = key_checker(item, 'unit cell')
        alpha.crystal_symmetry = key_checker(item, 'crystal symmetry')
        alpha.save()
